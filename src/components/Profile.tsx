          ...
          <div className="flex flex-row gap-[14px] ">
            ...
            <div className="flex flex-col items-start gap-[14px]">
              <div className="flex flex-row w-[528px] justify-between gap-[239px] rounded-md bg-white shadow-md">
                ...
                <div className=" flex items-center text-black font-Outfit text-xs font-medium leading-normal ">
                  View All
                </div>
              </div>
              ...
              <div className="w-[528px] h-[124px] flex shrink-0 flex-col">
                ...
                <div> </div>
                <div className="w-[93px] h-[28px] flex shrink-0 text-black font-Outfit text-base font-medium leading-normal ">
                  22 of 30 left
                </div>
              </div>
